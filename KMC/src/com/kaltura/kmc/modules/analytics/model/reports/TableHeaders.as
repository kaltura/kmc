package com.kaltura.kmc.modules.analytics.model.reports
{
	...
	public class TableHeaders
	{
		...
		public var userEngagement : Array = ['user_id','unique_videos','count_plays','sum_time_viewed','avg_time_viewed','avg_view_drop_off','count_loads','load_play_ratio'];
		public var userEngagementDrilldown : Array = ['count_video','count_plays','sum_time_viewed','avg_time_viewed','avg_view_drop_off','count_loads','load_play_ratio'];
