package com.kaltura.kmc.modules.analytics.model.reports
{
	...
	public class AggregateHeaders
	{
		...
		public var topContentPerUser : Array = [ 'unique_known_users','unique_videos','count_plays','sum_time_viewed','avg_time_viewed', 'avg_view_drop_off', 'count_loads','load_play_ratio'];
		...
		public var publisherBandwidthNStorage : Array = ['bandwidth_consumption', 'storage_used', 'combined_bandwidth_storage'];
