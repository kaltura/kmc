package com.kaltura.kmc.modules.analytics.model.reports
{
	...
	public class AggregateHeaders
	{
		...
		public var publisherBandwidthNStorage : Array = ['bandwidth_consumption', 'average_storage', 'peak_storage', 'added_storage', 'deleted_storage', 'combined_bandwidth_storage', 'transcoding_consumption', 'aggregated_monthly_avg_storage'];
