...
package com.kaltura.vo
{
	...
	[Bindable]
	public dynamic class KalturaFacebookDistributionJobProviderData extends KalturaConfigurableDistributionJobProviderData
	{
		/**
		**/
		...
		**/
		...
		override public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				case 'captionsInfo':
					result = 'KalturaFacebookCaptionDistributionInfo';
					break;
				default:
