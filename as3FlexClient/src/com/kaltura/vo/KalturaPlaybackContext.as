...
package com.kaltura.vo
{
	...
	[Bindable]
	public dynamic class KalturaPlaybackContext extends BaseFlexVo
	{
		/**
		**/
		public var sources : Array = null;
		...
		public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				...
				case 'actions':
					...
					break;
				case 'messages':
					result = 'KalturaAccessControlMessage';
					break;
			}
			return result;
		}
