...
package com.kaltura.commands.batch
{
	...
	import com.kaltura.delegates.batch.BatchResetJobExecutionAttemptsDelegate;
	import com.kaltura.net.KalturaCall;

	/**
	* batch resetJobExecutionAttempts action resets the execution attempts of the job
	**/
	public class BatchResetJobExecutionAttempts extends KalturaCall
	{
		...
		**/
		public function BatchResetJobExecutionAttempts( id : int,lockKey : KalturaExclusiveLockKey,jobType : String )
		{
			service= 'batch';
