...
{
	import com.kaltura.delegates.liveChannel.LiveChannelCreateRecordedEntryDelegate;
	import com.kaltura.net.KalturaCall;

	/**
	* Create recorded entry id if it doesn't exist and make sure it happens on the DC that the live entry was created on.
	**/
	public class LiveChannelCreateRecordedEntry extends KalturaCall
	{
		...
		**/
		public function LiveChannelCreateRecordedEntry( entryId : String,mediaServerIndex : String,liveEntryStatus : int )
		{
			service= 'livechannel';
		...
		override public function execute() : void
		{
			...
			delegate = new LiveChannelCreateRecordedEntryDelegate( this , config );
		}
	}
}
