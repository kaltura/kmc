...
package com.kaltura.commands.liveChannel
{
	...
	**/
	public class LiveChannelRegisterMediaServer extends KalturaCall
	{
		...
		* @param shouldCreateRecordedEntry Boolean
		**/
		public function LiveChannelRegisterMediaServer( entryId : String,hostname : String,mediaServerIndex : String,applicationName : String = null,liveEntryStatus : int=1,shouldCreateRecordedEntry : Boolean=true )
		{
			service= 'livechannel';
			...
			keyArr.push('shouldCreateRecordedEntry');
			valueArr.push(shouldCreateRecordedEntry);
