...
package com.kaltura.commands.liveChannel
{
	...
	**/
	public class LiveChannelAppendRecording extends KalturaCall
	{
		...
		**/
		public function LiveChannelAppendRecording( entryId : String,assetId : String,mediaServerIndex : int,resource : KalturaDataCenterContentResource,duration : Number,isLastChunk : Boolean=false )
		{
			service= 'livechannel';
