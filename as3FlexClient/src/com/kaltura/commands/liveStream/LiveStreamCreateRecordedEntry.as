...
package com.kaltura.commands.liveStream
{
	...
	**/
	public class LiveStreamCreateRecordedEntry extends KalturaCall
	{
		...
		**/
		public function LiveStreamCreateRecordedEntry( entryId : String,mediaServerIndex : String,liveEntryStatus : int )
		{
			service= 'livestream';
		...
		override public function execute() : void
		{
			...
			delegate = new LiveStreamCreateRecordedEntryDelegate( this , config );
		}
	}
}
