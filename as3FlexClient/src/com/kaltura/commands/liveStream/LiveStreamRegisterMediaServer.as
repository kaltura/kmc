...
package com.kaltura.commands.liveStream
{
	...
	**/
	public class LiveStreamRegisterMediaServer extends KalturaCall
	{
		...
		**/
		public function LiveStreamRegisterMediaServer( entryId : String,hostname : String,mediaServerIndex : String,applicationName : String = null,liveEntryStatus : int=1,shouldCreateRecordedEntry : Boolean=true )
		{
			service= 'livestream';
