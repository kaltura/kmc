...
package com.kaltura.controls.kobjecthadles.handles
{
	...
	public class DownLeftHandle extends HandleBase
	{
		...
		public function DownLeftHandle( container:Container ,
										defaultLook:Boolean=true ,
										userIcon:Class=null ,
										fillColor:uint=0x000000 ,
										fillAlph:Number=1 ,
										squareSize:Number=8,
										shapeType:String=HandleBase.SQUARE)
		{
		...
		{
			HandleCursorManager.getInstance().setCursorHandle( HandleCursorManager.DOWN_LEFT , this.stage );
