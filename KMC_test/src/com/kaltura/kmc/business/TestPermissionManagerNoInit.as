...
//		[Test]
//		/**
//		 * after denying the permission that has no group, the relevant
//		 * vo is returned when asking for relevant permissions.
//		 */
//		public function testGrouplessPermission():void {
//			var test1:XML = <root>
//					<permissions>
//						<permissionGroup text="Playlist Management" id="PLAYLIST_BASE">
//							<permission text="Create Playlists" id="PLAYLIST_ADD">
...
//					</uimapping>
//				</root>;
//			var permits:String = "PLAYLIST_BASE,PLAYLIST_ADD,PLAYLIST_DELETE,CONTENT_MODERATE_BASE," +
//				"CONTENT_MODERATE_METADATA,ANALYTICS_BASE,CONTENT_INGEST_BULK_UPLOAD"; //CONTENT_INGEST_UPLOAD,
//			PermissionManager.getInstance().init(test1, permits);
//			var vos:Array = PermissionManager.getInstance().getRelevantPermissions("playlist");
//		}
